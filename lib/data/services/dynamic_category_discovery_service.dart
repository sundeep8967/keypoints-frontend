...
class DynamicCategoryDiscoveryService {
  ...
  /// Discover and return available categories
  static Future<List<String>> discoverCategories() async {
    AppLogger.debug('📋 DISCOVERY: Returning static category list');
    // Return a static list of common categories
    return [
      'All',
      'Technology',
      'Business',
